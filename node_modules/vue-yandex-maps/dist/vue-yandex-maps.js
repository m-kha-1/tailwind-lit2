...
import { t as throwException, g as getException, c as createYmapsOptions, V as VueYandexMaps, i as initYmaps, a as copy, e as excludeKeys, s as sleep } from "./vue-yandex-maps-CjZi1za-.js";
import { getCurrentInstance, inject, isRef, watch, defineComponent, shallowRef, ref, provide, computed, onMounted, onBeforeUnmount, nextTick, h, version } from "vue";
...
const _sfc_main$8 = defineComponent({
  ...
  setup(props, {
    ...
    onMounted(async () => {
      mapChildren = await setupMapChildren({
        createFunction: (controls) => new ymaps3.YMapScaleControl(props.settings),
        settings: computed(() => props.settings),
        strictMapRoot: true
      });
      emit("input", mapChildren);
...
const _sfc_main$3 = defineComponent({
  ...
  setup(props, { slots, emit }) {
    ...
    return () => {
      ...
      return h("div", {
        key: features.value.map((x) => x.clusterer.clusterId).join(",")
      }, [clusterSlots]);
    };
  }
});
